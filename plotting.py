...
def plot_scatter_dim_reduction(
    X_reduced_tsne, X_reduced_pca, X_reduced_truncated_svd, y, output_path
):
    fig, ax = plt.subplots(nrows=1, ncols=3, figsize=(20, 6))
...
def plot_learning_curve(
    ...
    ax1.fill_between(
        train_size_lr,
        lr_train_score_mean - lr_train_score_std,
        lr_train_score_mean + lr_train_score_std,
        alpha=0.1,
        color="#ff9124",
    )
    ax1.fill_between(
        train_size_lr,
        lr_test_score_mean - lr_test_score_std,
        lr_test_score_mean + lr_test_score_std,
        alpha=0.1,
        color="#2492ff",
    )
    ...
    ax2.fill_between(
        train_size_kn,
        kn_train_score_mean - kn_train_score_std,
        kn_train_score_mean + kn_train_score_std,
        alpha=0.1,
        color="#ff9124",
    )
    ax2.fill_between(
        train_size_kn,
        kn_test_score_mean - kn_test_score_std,
        kn_test_score_mean + kn_test_score_std,
        alpha=0.1,
        color="#2492ff",
    )
    ...
    ax3.fill_between(
        train_size_svc,
        svc_train_score_mean - svc_train_score_std,
        svc_train_score_mean + svc_train_score_std,
        alpha=0.1,
        color="#ff9124",
    )
    ax3.fill_between(
        train_size_svc,
        svc_test_score_mean - svc_test_score_std,
        svc_test_score_mean + svc_test_score_std,
        alpha=0.1,
        color="#2492ff",
    )
    ...
    ax4.fill_between(
        train_size_tree,
        tree_train_score_mean - tree_train_score_std,
        tree_train_score_mean + tree_train_score_std,
        alpha=0.1,
        color="#ff9124",
    )
    ax4.fill_between(
        train_size_tree,
        tree_test_score_mean - tree_test_score_std,
        tree_test_score_mean + tree_test_score_std,
        alpha=0.1,
        color="#2492ff",
    )
